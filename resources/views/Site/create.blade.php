...
@section('content')
<form id="create" action="{{ route('Site.store') }}" method="POST">
    @csrf
    <div class="">
        <div>
        ...
        <div>
            ...
            <input type="text" Id="Site" name="Site" require>
        </div>
        <div>
        ...
        <div>
            ...
            <input type="datetime-local" name="StartDate" require>
        </div>
        <div>
            <label for="EndDate">描述</label>
            <input type="datetime-local" name="EndDate" require>
        </div>
